...
public class ReserveActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        plants.add(new Plant("Mountain Cedar Wattle", R.drawable.wz, "Acacia elata the cedar wattle or mountain cedar wattle is a tree found in eastern Australia.", "The tree can grow to a height of around 20 m (66 ft) when mature, with exceptional specimens reaching over 30 m (98 ft). It has deeply fissured bark with a dark brown to black colour at the base of the tree with terete branchlets that are hairy when young. The dark green evergreen leaves typically have a length of 2.5 to 9 cm (0.98 to 3.54 in) with one prominent gland about halfway along. "));
